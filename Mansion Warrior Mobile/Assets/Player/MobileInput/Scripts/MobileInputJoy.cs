...
public class MobileInputJoy : MobileInputElement
{
    ...
    public override bool HandleTouch(Touch touch)
    {
        ...
        if (handlePosition.magnitude > handleMaxRadius)
            handlePosition = handlePosition.normalized * handleMaxRadius;
    ...
    {
        fingerId = -1;
        handle.anchoredPosition = Input = DeltaInput = Vector2.zero;
    }
}
